...
import { Scene1_Hook } from "./scenes/Scene1_Hook_v2";
import { Scene2_Speed } from "./scenes/Scene2_Speed_v2";
import { Scene3_Depth } from "./scenes/Scene3_Depth_v2";
import { Scene4_Power } from "./scenes/Scene4_Power_v2";
import { Scene5_Workflow } from "./scenes/Scene5_Workflow_v2";
...
export const PromoVideo: React.FC<PromoVideoProps> = ({ format }) => {
  return (
    ...
    >
      <Series>
        {/* Scene 1: Hook - Hex code → screenshot transition (0-2s, 60 frames) */}
